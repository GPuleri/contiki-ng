...
#Set the pattern to retrieve the data
...
#Calculate the energy consumption second by second
for values in stats:
    #CPU energy
    ...
    if int(values[3])!=0:
        Total_energy_persecond=Total_energy/int(values[3])
    else:
        Total_energy_persecond=0
