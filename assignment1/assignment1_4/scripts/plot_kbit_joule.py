...
row1=data1['kbit/Joule_mean'][0]
row2=data2['kbit/Joule_mean'][0]
row3=data3['kbit/Joule_mean'][0]
r1=data1['kbit/Joule_std'][0]
r2=data2['kbit/Joule_std'][0]
r3=data3['kbit/Joule_std'][0]
...
plt.suptitle('kbit/Joule')
plt.xlabel('TX value (dBm)')
plt.ylabel('kbit/Joule')
