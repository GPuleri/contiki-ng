...
row1=data1['Latency_mean (ms)'][0]
row2=data2['Latency_mean (ms)'][0]
row3=data3['Latency_mean (ms)'][0]
r1=data1['Latency_std (ms)'][0]
r2=data2['Latency_std (ms)'][0]
r3=data3['Latency_std (ms)'][0]
